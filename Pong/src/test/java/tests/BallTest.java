...
public class BallTest {
    ...
    @Test
    public void setSpriteCorrectYMovement() {
        testBall.setSprite(12, 2, 3);
        assertEquals(true, Math.abs(0 - testBall.getYMovement()) <= 0.000001);
    }
    
    @Test
    public void setSpriteCorrectXMovement() {
        testBall.setSprite(12, 2, 3);
        assertEquals(true, Math.abs(0 - testBall.getXMovement()) <= 0.000001);
    }
    
    @Test
    public void setSpriteCorrectX() {
        testBall.setSprite(12, 2, 3);
        assertEquals(true, Math.abs(2 - testBall.getxPosition()) <= 0.000001);
    }
    
    @Test
    public void setSpriteCorrectY() {
        testBall.setSprite(12, 2, 3);
        assertEquals(true, Math.abs(3 - testBall.getyPosition()) <= 0.000001);
    }
    
    @Test
    public void setSpriteCorrectRadius() {
        testBall.setSprite(12, 2, 3);
        assertEquals(12, testBall.getRadius());
    }
    ...
    public void getSpriteCorrectX() {
        Shape testShape = testBall.getSprite();
        assertEquals(true, Math.abs(15 - testShape.getTranslateX()) <= 0.000001 );
    }
    
    @Test
    public void getSpriteCorrectY() {
        Shape testShape = testBall.getSprite();
        assertEquals(true, Math.abs(20 - testShape.getTranslateY()) <= 0.000001 );
    }
